...
configure_git() {
    ...
    echo "[![Build Status](${GITHUB_SERVER_URL}/${GITHUB_REPOSITORY}/workflows/CI/badge.svg)](${GITHUB_SERVER_URL}/${GITHUB_REPOSITORY}/actions/${GITHUB_ACTION})" > ./.mdimechanic/ci_badge.md
}
